...
## Answer
First, we should find own IP Address in terminal with command "ifconfig en0"



Copy the IP Address and also open the Wireshark. Then, filter with "ip.src == own IP Address"
